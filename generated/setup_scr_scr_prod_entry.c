...
void setup_scr_scr_prod_entry(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->scr_prod_entry_lbl_pe_tiltle, 306, 22);
    lv_obj_set_size(ui->scr_prod_entry_lbl_pe_tiltle, 668, 62);
    ...
    lv_obj_set_style_text_font(ui->scr_prod_entry_lbl_pe_tiltle, &lv_font_NotoSans_Bold_50, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scr_prod_entry_cont_total_finished, 0, 30);
    lv_obj_set_size(ui->scr_prod_entry_cont_total_finished, 600, 320);
    ...
    lv_obj_set_style_border_width(ui->scr_prod_entry_cont_total_finished, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->scr_prod_entry_cont_total_finished, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->scr_prod_entry_cont_total_finished, lv_color_hex(0x16A34A), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->scr_prod_entry_cont_total_finished, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->scr_prod_entry_cont_total_finished, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->scr_prod_entry_cont_total_finished, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->scr_prod_entry_cont_total_finished, lv_color_hex(0x1e1e1e), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scr_prod_entry_lbl_total_title, 0, 0);
    lv_obj_set_size(ui->scr_prod_entry_lbl_total_title, 587, 60);
    ...
    lv_obj_set_style_text_color(ui->scr_prod_entry_lbl_total_title, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->scr_prod_entry_lbl_total_title, &lv_font_NotoSans_Bold_40, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->scr_prod_entry_lbl_total_title, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scr_prod_entry_ta_total_finished, 0, 65);
    lv_obj_set_size(ui->scr_prod_entry_ta_total_finished, 586, 220);
    lv_textarea_set_text(ui->scr_prod_entry_ta_total_finished, "0");
    ...
    lv_textarea_set_one_line(ui->scr_prod_entry_ta_total_finished, false);
    ...
    lv_obj_set_style_text_font(ui->scr_prod_entry_ta_total_finished, &lv_font_NotoSans_Bold_100, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->scr_prod_entry_ta_total_finished, 50, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scr_prod_entry_cont_ng_qly, 633, 30);
    lv_obj_set_size(ui->scr_prod_entry_cont_ng_qly, 600, 320);
    ...
    lv_obj_set_style_border_width(ui->scr_prod_entry_cont_ng_qly, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->scr_prod_entry_cont_ng_qly, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->scr_prod_entry_cont_ng_qly, lv_color_hex(0xDC2626), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->scr_prod_entry_cont_ng_qly, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->scr_prod_entry_cont_ng_qly, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->scr_prod_entry_cont_ng_qly, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->scr_prod_entry_cont_ng_qly, lv_color_hex(0x1e1e1e), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scr_prod_entry_lbl_ng_title, -4, 0);
    lv_obj_set_size(ui->scr_prod_entry_lbl_ng_title, 594, 60);
    ...
    lv_obj_set_style_text_color(ui->scr_prod_entry_lbl_ng_title, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->scr_prod_entry_lbl_ng_title, &lv_font_NotoSans_Bold_40, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->scr_prod_entry_lbl_ng_title, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scr_prod_entry_ta_ng_quantity, 0, 65);
    lv_obj_set_size(ui->scr_prod_entry_ta_ng_quantity, 586, 220);
    lv_textarea_set_text(ui->scr_prod_entry_ta_ng_quantity, "0");
    ...
    lv_textarea_set_one_line(ui->scr_prod_entry_ta_ng_quantity, false);
    ...
    lv_obj_set_style_text_color(ui->scr_prod_entry_ta_ng_quantity, lv_color_hex(0xEF4444), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->scr_prod_entry_ta_ng_quantity, &lv_font_NotoSans_Bold_100, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->scr_prod_entry_ta_ng_quantity, 50, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->scr_prod_entry_btn_pe_submit, 600, 80);
    ...
    lv_obj_set_style_radius(ui->scr_prod_entry_btn_pe_submit, 14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->scr_prod_entry_btn_pe_submit, &lv_font_NotoSans_Bold_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scr_prod_entry_ta_pe_note, 1, 15);
    lv_obj_set_size(ui->scr_prod_entry_ta_pe_note, 1230, 90);
    lv_textarea_set_text(ui->scr_prod_entry_ta_pe_note, "Add note...");
    ...
    lv_obj_set_style_text_color(ui->scr_prod_entry_ta_pe_note, lv_color_hex(0xababab), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->scr_prod_entry_ta_pe_note, &lv_font_NotoSans_Regular_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->scr_prod_entry_ta_pe_note, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->scr_prod_entry_ta_pe_note, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->scr_prod_entry_ta_pe_note, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->scr_prod_entry_ta_pe_note, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->scr_prod_entry_ta_pe_note, lv_color_hex(0x2b2f36), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->scr_prod_entry_ta_pe_note, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->scr_prod_entry_ta_pe_note, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->scr_prod_entry_ta_pe_note, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->scr_prod_entry_ta_pe_note, lv_color_hex(0x575757), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->scr_prod_entry_ta_pe_note, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scr_prod_entry_ta_pe_note, 14, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for scr_prod_entry_ta_pe_note, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
    lv_obj_set_style_text_color(ui->scr_prod_entry_ta_pe_note, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_text_font(ui->scr_prod_entry_ta_pe_note, &lv_font_NotoSans_Regular_30, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_text_opa(ui->scr_prod_entry_ta_pe_note, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_bg_opa(ui->scr_prod_entry_ta_pe_note, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_bg_color(ui->scr_prod_entry_ta_pe_note, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_bg_grad_dir(ui->scr_prod_entry_ta_pe_note, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->scr_prod_entry_ta_pe_note, 2, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_opa(ui->scr_prod_entry_ta_pe_note, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_color(ui->scr_prod_entry_ta_pe_note, lv_color_hex(0xe6e6e6), LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_side(ui->scr_prod_entry_ta_pe_note, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_shadow_width(ui->scr_prod_entry_ta_pe_note, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_top(ui->scr_prod_entry_ta_pe_note, 4, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_right(ui->scr_prod_entry_ta_pe_note, 4, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_left(ui->scr_prod_entry_ta_pe_note, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->scr_prod_entry_ta_pe_note, 10, LV_PART_MAIN|LV_STATE_FOCUSED);
    ...
    lv_obj_set_pos(ui->scr_prod_entry_btn_cancel, 0, 138);
    lv_obj_set_size(ui->scr_prod_entry_btn_cancel, 600, 80);
    ...
    lv_obj_set_style_radius(ui->scr_prod_entry_btn_cancel, 14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->scr_prod_entry_btn_cancel, &lv_font_NotoSans_Bold_30, LV_PART_MAIN|LV_STATE_DEFAULT);
