...
void setup_scr_scr_SetupDataSync(lv_ui *ui)
{
    ...
    //Write codes scr_SetupDataSync_cont_top_right
    ui->scr_SetupDataSync_cont_top_right = lv_obj_create(ui->scr_SetupDataSync_cont_topbar);
    lv_obj_set_pos(ui->scr_SetupDataSync_cont_top_right, 990, 0);
    lv_obj_set_size(ui->scr_SetupDataSync_cont_top_right, 270, 90);
    lv_obj_set_scrollbar_mode(ui->scr_SetupDataSync_cont_top_right, LV_SCROLLBAR_MODE_OFF);

    //Write style for scr_SetupDataSync_cont_top_right, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->scr_SetupDataSync_cont_top_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->scr_SetupDataSync_cont_top_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->scr_SetupDataSync_cont_top_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->scr_SetupDataSync_cont_top_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->scr_SetupDataSync_cont_top_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->scr_SetupDataSync_cont_top_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->scr_SetupDataSync_cont_top_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->scr_SetupDataSync_cont_top_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes scr_SetupDataSync_lbl_device
    ui->scr_SetupDataSync_lbl_device = lv_label_create(ui->scr_SetupDataSync_cont_top_right);
    lv_obj_set_pos(ui->scr_SetupDataSync_lbl_device, 1, 39);
    ...
    ui->scr_SetupDataSync_btn_online = lv_button_create(ui->scr_SetupDataSync_cont_top_right);
    lv_obj_set_pos(ui->scr_SetupDataSync_btn_online, 128, 30);
    lv_obj_set_size(ui->scr_SetupDataSync_btn_online, 130, 50);
