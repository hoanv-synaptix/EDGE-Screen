...
void setup_scr_boot(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->boot_cont_center, 900, 555);
    ...
    lv_obj_set_pos(ui->boot_img_logo, 354, 61);
    ...
    lv_obj_set_pos(ui->boot_lbl_title, 286, 284);
    ...
    lv_obj_set_style_text_font(ui->boot_lbl_title, &lv_font_NotoSans_Bold_40, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->boot_lbl_status, 299, 366);
    ...
    lv_obj_set_style_text_font(ui->boot_lbl_status, &lv_font_NotoSans_Bold_26, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->boot_bar_1 = lv_bar_create(ui->boot_cont_center);
    lv_obj_set_pos(ui->boot_bar_1, 204, 445);
